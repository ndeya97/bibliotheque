package com.biblio.theque.groupe8.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.biblio.theque.groupe8.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.biblio.theque.groupe8.repository.UserRepository.USERS_BY_EMAIL_CACHE);
