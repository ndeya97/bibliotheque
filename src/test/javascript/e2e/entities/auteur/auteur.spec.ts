...
describe('Auteur e2e test', () => {
  ...
  it('should load Auteurs', async () => {
    ...
    expect(await auteurComponentsPage.getTitle()).to.eq('bibliothequeApp.auteur.home.title');
  ...
  it('should load create Auteur page', async () => {
    ...
    expect(await auteurUpdatePage.getPageTitle()).to.eq('bibliothequeApp.auteur.home.createOrEditLabel');
  ...
  it('should delete last Auteur', async () => {
    ...
    expect(await auteurDeleteDialog.getDialogTitle()).to.eq('bibliothequeApp.auteur.delete.question');
