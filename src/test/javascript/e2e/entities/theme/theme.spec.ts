...
describe('Theme e2e test', () => {
  ...
  it('should load Themes', async () => {
    ...
    expect(await themeComponentsPage.getTitle()).to.eq('bibliothequeApp.theme.home.title');
  ...
  it('should load create Theme page', async () => {
    ...
    expect(await themeUpdatePage.getPageTitle()).to.eq('bibliothequeApp.theme.home.createOrEditLabel');
  ...
  it('should delete last Theme', async () => {
    ...
    expect(await themeDeleteDialog.getDialogTitle()).to.eq('bibliothequeApp.theme.delete.question');
