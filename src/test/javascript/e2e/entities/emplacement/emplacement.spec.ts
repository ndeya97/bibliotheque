...
describe('Emplacement e2e test', () => {
  ...
  it('should load Emplacements', async () => {
    ...
    expect(await emplacementComponentsPage.getTitle()).to.eq('bibliothequeApp.emplacement.home.title');
    await browser.wait(
  ...
  it('should load create Emplacement page', async () => {
    ...
    expect(await emplacementUpdatePage.getPageTitle()).to.eq('bibliothequeApp.emplacement.home.createOrEditLabel');
  ...
  it('should delete last Emplacement', async () => {
    ...
    expect(await emplacementDeleteDialog.getDialogTitle()).to.eq('bibliothequeApp.emplacement.delete.question');
