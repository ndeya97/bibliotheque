...
describe('Livre e2e test', () => {
  ...
  it('should load Livres', async () => {
    ...
    expect(await livreComponentsPage.getTitle()).to.eq('bibliothequeApp.livre.home.title');
  ...
  it('should load create Livre page', async () => {
    ...
    expect(await livreUpdatePage.getPageTitle()).to.eq('bibliothequeApp.livre.home.createOrEditLabel');
  ...
  it('should create and save Livres', async () => {
    ...
    await promise.all([
      ...
      livreUpdatePage.setDesciptionInput('desciption'),
    ...
    expect(await livreUpdatePage.getDesciptionInput()).to.eq('desciption', 'Expected Desciption value to be equals to desciption');
  ...
  it('should delete last Livre', async () => {
    ...
    expect(await livreDeleteDialog.getDialogTitle()).to.eq('bibliothequeApp.livre.delete.question');
